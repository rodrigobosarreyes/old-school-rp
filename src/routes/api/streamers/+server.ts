...
export async function GET() {
  ...
  const streamersList = {
    streamers: [
      ...
      {username: 'bytraap', character: 'John Park', role: 'Policía', status: false, social: {twitter: 'https://twitter.com/bytraap', instagram: 'https://www.instagram.com/bytraap'}},
      ...
      {username: 'minibaeee', character: 'Alina Atayan', role: 'Civil', status: false, social: {instagram: 'https://www.instagram.com/minibaeee', tiktok: 'https://www.tiktok.com/@minibaeeee'}},
      ...
      {username: 'sir_ragot', character: 'Santiago Bedoya', role: 'Civil', status: false, social: {instagram: 'https://www.instagram.com/rafagome.z/', twitter: 'https://twitter.com/SirRagot'}},
      {username: 'ExcoJM', character: 'Samuel Fernández', role: 'Civil', status: false, social: {twitter: 'https://twitter.com/ExcoJm', tiktok: 'https://www.tiktok.com/@excojm', instagram: 'https://www.instagram.com/excojm'}},
      ...
      {username: 'ElAguaLimon', character: 'Wang Zhao', role: 'Banda', status: false, social: {instagram: 'https://www.instagram.com/elagualimon', tiktok: 'https://www.tiktok.com/@elagualimon', twitter: 'https://twitter.com/elagualimon'}},
      ...
      {username: 'Clottay', character: 'Thalía Fernández', role: 'Civil', status: false, social: {twitter: 'https://twitter.com/clottay', instagram: 'https://www.instagram.com/clottay_'}},
      ...
      {username: 'CamareroRp', character: 'Big Jeff', role: 'Banda', status: false, social: {twitter: 'https://twitter.com/CamareroRp'}},
      ...
      {username: 'destructorhell', character: 'Ralph Beekhof', role: 'Civil', status: false, social: {tiktok: 'https://www.tiktok.com/@destructorhell'}},
    ] as Streamer[]
  };
